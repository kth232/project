...
<body>
	...
	<div class="surveylist__title">
		<span id="surveylist__title__text" text-align = 'center'>설문 관리</span>
	</div>

	<form action="adminSurveyListSearch.jsp" method="get" accept-charset="utf-8" id="afrm1">
				...
				<table class="list_table">
					<tr>
						...
						<td class="list_search">
							...
							<button onclick="document.getElementById('afrm1').submit();"><img src="../images/search.png"></button>
						</td>
					</tr>
				</table>
		</div>
